...
class Transform {
  ...
  flipX() {
    ...
    const y = 0;
    const tfm1 = _owner.get(this).createSVGTransform();
    const tfm2 = _owner.get(this).createSVGTransform();
    const tfmList = _tfmList.get(this);

    tfm1.setScale(-1, 1);
    tfmList.appendItem(tfm1);
    tfm2.setTranslate(x, y);
    tfmList.appendItem(tfm2);
  }
